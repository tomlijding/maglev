...
% Revised by Gijs van der Veen, 2011
...
if MatlabVersion(1)<'6',
    ...
    % LevenbergMarquardt was removed in R2011b!
    if ~isfield(curroptions,'LevenbergMarquardt')
        if ~isempty(options.LevenbergMarquardt)
            curroptions.LevenbergMarquardt = options.LevenbergMarquardt;
        else
            curroptions.LevenbergMarquardt = defaultopt.LevenbergMarquardt;
        end
    end
end
